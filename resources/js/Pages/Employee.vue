<template>
  ...
  <AuthenticatedLayout>
    ...
    <!-- Add/Edit Ice Cream Modal -->
      <div v-if="showAddIceCreamModal" class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div
              ...
              <div class="mt-3 text-center sm:mt-5">
                ...
                <div class="mt-2">
                  ...
                  <input v-model="currentIceCream.stock" type="number" placeholder="Stock"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                  <input v-model="currentIceCream.manufactured_date" type="date" placeholder="Manufactured Date"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
            ...
            <div class="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
              <button @click="editingIceCream ? saveIceCream() : addIceCream()" type="button"
...
const addIceCream = async () => {
  try {
    ...
    console.log("Sending data to the server:", {
      flavor: currentIceCream.value.flavor,
    ...
    // Send the data to the backend
      await router.post(route("employee.add"), {
      flavor: currentIceCream.value.flavor,
      description: currentIceCream.value.description,
      price: currentIceCream.value.price,
      stock: currentIceCream.value.stock,
    ...
    console.error("Failed to add ice cream:", error.response?.data || error.message);
